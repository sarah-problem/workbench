...
const MEASURES = {
  ...
  bce: {
    short:"BCEs", title:"Benevolent Childhood Experiences Scale (BCEs)", age:"For favorable experiences occurring from birth through age 18; commonly completed retrospectively by adults.", instructions:"Select Yes for each experience that was present during childhood.",
    questions:["At least one caregiver with whom you felt safe","At least one good friend","Beliefs that gave you comfort","Enjoyment of school","At least one teacher who cared about you","Good neighbors","An adult other than a parent or caregiver who could provide support or advice","Opportunities to have a good time","Being able to like yourself or feel comfortable with yourself","A predictable home routine, such as regular meals and bedtime"].map(text=>({text,options:YES_NO})), max:10,
    score(a){const n=a.reduce(sum,0);return{score:`${n} / 10`,result:`${n} benevolent childhood ${n===1?"experience":"experiences"} endorsed`,note:"Higher totals reflect more favorable childhood experiences. There is no diagnostic cutoff; use the individual responses to identify sources of safety, predictability, connection, and support."};},
    note:"BCEs complement rather than cancel adverse experiences. Avoid treating either the BCE or ACE total as an individual prediction; use the response pattern to support developmental formulation and identify potential resources.", attribution:"Benevolent Childhood Experiences Scale (Narayan et al., 2018)."
  },
  asrs: {
